...
export default {
    ...
    watch: {
        show: function (newValue) {
            ...
            this.critics_score = newValue.critics_score
            this.audience_score = newValue.audience_score
            this.release_date = newValue.release_date
